...
function App() {
  ...
  const releasedDate = new Date("2023-12-27");
  const differentDate = new Date() - releasedDate;
  const number_of_days = Math.floor(differentDate / (1000 * 60 * 60 * 24));
  return (
      ...
      <div className="d-flex justify-content-end ">
        <div className="dropdown">
          ...
          <ul className="dropdown-menu">
            ...
            {languages.map(({ code, name, contury_code }) => (
              <li key={contury_code}>
                <button
                ...
                >
                  <span
                    ...
                    className={`flag-icon flag-icon${contury_code} mx-2`}
                  ></span>
                  {name}
                </button>
              </li>
